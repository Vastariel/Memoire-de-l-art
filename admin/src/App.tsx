...
import {
  DashboardOutlined, PictureOutlined, TeamOutlined,
            ...
            <Refine
              resources={[
                ...
                },
                {
                  name: 'artworks',
                  list: '/artworks',
                  create: '/artworks/upload',
                  meta: { label: 'Œuvres', icon: <PictureOutlined /> },
                },
                {
                  name: 'instances',
                  list: '/instances',
                  meta: { label: 'Instances', icon: <TeamOutlined /> },
                },
              ]}
            >
              <ThemedLayoutV2
                Sider={() => (
                  <ThemedSiderV2
                    Title={() => (
                      <ThemedTitleV2 collapsed={false} text="Mémoire de l'art" />
                    )}
                  />
                )}
              >
